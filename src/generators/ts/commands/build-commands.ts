...
import { CreateCommand } from "./dynamodb/create-command";
import { DeleteCommand } from "./dynamodb/delete-command";
import { ImportCommand } from "./dynamodb/import-command";
import { ReadCommand } from "./dynamodb/read-command";
import { UpdateCommand } from "./dynamodb/update-command";
...
export class BuildTypeScriptCommands extends FractureComponent {
  ...
  constructor(resource: Resource) {
    ...
    resource.operations.forEach((operation) => {
      /***********************************************************************
       *
       * Build Dynamo Commands
       *
       * Construct each dynamo command type.
       *
       **********************************************************************/
