...
import {
  Error,
  CreateActorVersionInput,
  CreateActorVersionOutput,
  Response,
} from "../../types";
...
export const createActorVersion = async (
  input: CreateActorVersionInput
): Promise<Response<CreateActorVersionOutput>> => {
